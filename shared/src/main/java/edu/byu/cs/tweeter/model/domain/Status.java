...
public class Status implements Serializable {
    ...
    public Status(String post, User user, String datetime, String secondstime, List<String> urls, List<String> mentions) {
        this.post = post;
        this.user = user;
    ...
    public String getSecondstime() { return secondstime; }
